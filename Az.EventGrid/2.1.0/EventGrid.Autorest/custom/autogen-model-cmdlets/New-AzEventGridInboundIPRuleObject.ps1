...
function New-AzEventGridInboundIPRuleObject {
    ...
    Param(
        ...
        [Parameter(HelpMessage="Action to perform based on the match or no match of the IpMask.")]
        [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.PSArgumentCompleterAttribute("Allow")]
        [string]
        $Action,
        [Parameter(HelpMessage="IP Address in CIDR notation e.g., 10.0.0.0/8.")]
        [string]
        $IPMask
    )

    process {
        $Object = [Microsoft.Azure.PowerShell.Cmdlets.EventGrid.Models.InboundIPRule]::New()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDRMOPnJwCFBQ51
# Rm3Hf6uHr2mij22kei4fqEeW/rlWQaCCDXYwggX0MIID3KADAgECAhMzAAAEBGx0
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEyjazCN/ee9Epj/OiHwtik7
# Jb1XmtpTJSa7zOKKdS6/MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEArJHC4rtcUfnjLIbSm2rCglQ26aNaCw+s0biEQKASfTDvBbSN//sMRARW
# hk91re0Aiji2rNIkn908gkdMeczrIHAmchF5WjEahOKDs4zFvLActcb6BIb8qo61
# r9JoSgoXN0O8E4v8TChfz3kwdqxt6bilfGfkGBA++UYjexCbPf4XfLOuIUuYbaGJ
# LFJqTOSExjWNXOCJXHfFiSy3j84Cj607F3GbGFlXLttklpES84BpSMlXvoLOp11d
# 6i7D5KTUNt6NNfZvXYxSGgwdRB7X/izs20FC4IfIivwnXG6hnYGrCTY1DlWkomO2
# 3F5fjOaKEqhZXYO+f3FHpprB4VmoraGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCC
# F3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCBHT0xXoz6uqYFFNidFGi7/S1bdhEKxYkDrZ/bOinzv7AIGZxp18zl/
# GBMyMDI0MTEwMTE1MDQxNS4yMDRaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJBDEiBCB73J4Y6OPAALJZIXAmlHqx8MQsIyjelZRDiyHNKbmKfzCB
...
# QHK22XIfnjILxKswDQYJKoZIhvcNAQELBQAEggIAp7Mq9XjrgdzNorCs4nnon38Y
# h7q7pQVY9BilIEJLw30KORsffx2vo9HQCthzFT5sQfPFwb3MMO23ce94vojJHw2t
# PdoXIHn2Q3IRAlsT/z3uUc0FPDpfMaAOueJTXPL9cdWkJC42YvgfIUok2lgP0exY
# /OXBVEmaPGL8CnN0TQ8hzPa2EjHXokVJbO9T4IhDlVMu76uD0YHmXTHfsNzfY5EA
# DG1DoAIQAZqnD+SEpHC2m1555hJdTTLsU0uSZFiEPWF0Z0PTWs04IYLK/I8EyR8D
# ORfkNE1vPkGxgZS/omybGTYp3x9rInrjmpgP8Np/O5uE5ggKl2mtFexDluyLpyI4
# IgvFJTg5gZ/KLJ4c9JOo5+vN6qTzSiWOZZDawipIyG4kYtRLCRowY6SvAM28fzfQ
# tv3nUCd4bY0zViXUVvWuAtJ66GBbwtlCyuuhDBpp2410pk3TXVIdiYEyrASpERTc
# 8+J3N8Igpi+C3QYmoF0Fq+ZNclkzVw766+FLcZuiYkSQavsDlO8rUj03SGcJPefp
# R6ja3dyunmH2OjE1ZK3nwsDFxwd+BpX43b2dHQndRQFI1vFSAPhsKYi2F9WySjjF
# iEJfc0oFurPrq5o0RyNtd1WFSrecilsUrhVUrZCIUZVNFGQgFlOfZzmanFEMZcp3
# 9GShJ+pnGPlBRQdZNnA=
